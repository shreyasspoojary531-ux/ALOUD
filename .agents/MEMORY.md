...
- Large, bold centered phrase text with transparent WebGL SiriWave audio playing indicator (360px canvas with luminance alpha in `AlertPlayingIndicator.jsx` rendering `components/ui/SiriWave.jsx`).
