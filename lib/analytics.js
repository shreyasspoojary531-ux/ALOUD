...
/**
 * Retrieve raw analytics events from localStorage.
 */
...
export function getAnalyticsSummary() {
  ...
  if (events.length === 0) {
    return {
      ...
      sourceDistribution: { category: 0, suggestion: 0, spelled: 0, action: 0 },
      dailyBreakdown: [],
    };
  }
  ...
  const sourceCounts = { category: 0, suggestion: 0, spelled: 0, action: 0 };
  const dayCounts = {};
