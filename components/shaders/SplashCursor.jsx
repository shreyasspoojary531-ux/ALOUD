...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    if (!contextResult || !contextResult.gl) return;
    ...
    function getWebGLContext(targetCanvas) {
      ...
      let webglCtx = targetCanvas.getContext("webgl2", params);
    ...
    function getSupportedFormat(webglCtx, internalFormat, format, type) {
    ...
    function supportRenderTextureFormat(webglCtx, internalFormat, format, type) {
